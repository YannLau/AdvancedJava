...
<img src="/Users/yannlau/Documents/JavaSet/Java韩顺平/高阶专题/JVM专题/NOTE_JVM_宋红康/JVM上篇：内存与垃圾回收篇/03-运行时数据区及程序计数器/assets/QQ_1726731856539.png" alt="QQ_1726731856539" style="zoom:50%;" />
...
线程分为 守护线程 和 普通线程。如果仅剩守护线程，那么Java程序也就该结束了。
...
这里，并非是广义上所指的物理寄存器，或许将其翻译为 PC 计数器（或指令计数器）会更加贴切（也称为程序钩子），并且也不容易引起一些不必要的误会。<mark>JVM 中的 PC 寄存器是对物理 PC 寄存器的一种抽象模拟</mark>。
...
<img src="/Users/yannlau/Documents/JavaSet/Java韩顺平/高阶专题/JVM专题/NOTE_JVM_宋红康/JVM上篇：内存与垃圾回收篇/03-运行时数据区及程序计数器/assets/QQ_1726733438411.png" alt="QQ_1726733438411" style="zoom:50%;" />
